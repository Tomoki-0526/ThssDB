...
public class ExecuteStatementResp implements org.apache.thrift.TBase<ExecuteStatementResp, ExecuteStatementResp._Fields>, java.io.Serializable, Cloneable, Comparable<ExecuteStatementResp> {
  ...
  public int compareTo(ExecuteStatementResp other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIsAbort(), other.isSetIsAbort());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsAbort()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHasResult(), other.isSetHasResult());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHasResult()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRowList(), other.isSetRowList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRowList()) {
